            ...
            success: function (data) {
                ...
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < records.length; i++) {
                        ...
                        html += "<a href=\"#\"><img src=\""+result.logo+"\" onerror=\"src='/static/template/common/temp/01.png'\" width=\"184\" height=\"123\" /></a>";
                        html += "<div class=\"rgba_div\"></div>";
                        html += "<div class=\"parent pos_abs\"><span class=\"zan zan_cur con_color\"><b class=\"icons\"></b>"+result.clickCount+"</span></div>\n";
                        html += "</div>";
                        html += "<dl>";
                        html += "<dt><a href=\"#\">" + result.name + "</a></dt>";
                        html += "<dd>时间："+ result.beginTime +" 至 "+ result.endTime +"</dd>";
                        html += "<dd>地点："+ result.place +"</dd>";
                        html += "<dd>发起："+ result.hoster +"</dd>";
