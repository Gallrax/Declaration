        ...
        <div class="course_upload">
            ...
            <ul>
                <li>
                    ...
                    <div class="prompt_div"><div class="prompt_text"><b class="icons"></b>名字后面请用；隔开</div></div>
                </li>
                <li>
                    <div class="form_title"><span>*</span>联系方式：</div>
                    <input name="" type="text" class="fidtext" />
                    <div class="prompt_div"><div class="prompt_text"><b class="icons"></b>*号为必填信息</div></div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <input name="" type="text" class="fidtext" />
                    <div class="file-style"><input type="file" onChange="add_files(this.files)" id="file" name="file">请选择文件</div>
                    <div class="prompt_div"><div class="prompt_text"><b class="icons"></b>*号为必填信息</div></div>
                </li>
                <li>
